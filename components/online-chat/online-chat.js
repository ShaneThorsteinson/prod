...
export default function OnlineChat ({ className, matchId, isVisible = true, onToggleVisible = f => f }) {
  ...
  useEffect(() => {
    ApiService.getMatchMessages(matchId)
      .then(setMessages)
  ...
  const handleSubmit = event => {
    ...
    setIsLoading(true)
    ApiService.postMatchMessage(matchId, { message })
      .then(resultData => {
        // setMessages([
        //   ...messages,
        //   resultData
    ...
    <>
      ...
      {createPortal(
        <div className={classes}>
          ...
          <div className="online-chat__content">
